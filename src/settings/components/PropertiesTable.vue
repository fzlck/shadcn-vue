...
import DataTablePagination from '@/overview/components/DataTablePagination.vue';
...
<template>
   <div class="">
    <div class="rounded-md border-dark">
      <div class="max-h-[70vh] relative overflow-auto rounded-md">
        <Table>
    ...
    <DataTablePagination :table="table" :selectable="false" class="mt-2"/>
  </div>
</template>